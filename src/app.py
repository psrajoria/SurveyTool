...
#             ip_address=ip, user_agent=user_agent, consent_given=True
#         )
...
#         participant_id=session.get("participant_id"), completed=True
#     ).all()
...
#         if current_image >= len(photos):
#             # Mark all the user's responses as completed
#             responses = Response.query.filter_by(
